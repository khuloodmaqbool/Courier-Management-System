        ...
        <div class="row">
            <div class="col-8 mx-auto text-center">
                ...
                <ul class="list-inline breadcrumbs text-capitalize" style="font-weight:500">
                    ...
                    <li class="list-inline-item">/ &nbsp; <a href="services.php">Services</a>
                    </li>
                </ul>
            </div>
        </div>
...
<section class="section">
    <div class="container">
        <div class="row justify-content-center">
            <!-- Card 1: International Shipping -->
            <div class="icon-box-item text-center col-lg-4 col-md-6 mb-4">
                <div class="rounded shadow-sm py-5 px-4">
                    <div class="icon"> <i class="fas fa-user"></i></div>
                    <h3 class="mb-3">International Shipping</h3>
                    <p class="mb-4">Service for sending parcels to other countries.</p>
                    <button class="btn btn-sm" style="background-color: #696cff;color: white;" data-bs-toggle="modal"
                        data-bs-target="#internationalShippingModal">View Details <i
                            class="las la-arrow-right ms-1"></i></button>
                </div>
            </div>

            <!-- Modal 1: International Shipping -->
            <div class="modal fade" id="internationalShippingModal" tabindex="-1"
                aria-labelledby="internationalShippingModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="internationalShippingModalLabel">International Shipping</h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div class="modal-body">
                            <p>Our International Shipping service ensures safe and reliable delivery of your parcels to
                                any country around the globe. With tracking capabilities, customs clearance assistance,
                                and insurance options, we make global shipping seamless and stress-free. We also provide
                                special packaging for fragile items and offer express delivery options for
                                time-sensitive shipments.</p>
                            <ul>
                                <li>Worldwide delivery coverage</li>
                                <li>Customizable shipping options</li>
                                <li>Dedicated customer support for international logistics</li>
                            </ul>
                        </div>
                        <div class="modal-footer">
                            <a class="btn" style="background-color: #696cff;" href="contact.php">Contact Us</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="icon-box-item text-center col-lg-4 col-md-6 mb-4">
                <div class="rounded shadow py-5 px-4">
                    ...
                    <p class="mb-4">Options for urgent deliveries when needed.</p>
                    <button class="btn btn-sm" style="background-color: #696cff;color: white;" data-bs-toggle="modal"
                        data-bs-target="#sameDayDeliveryModal">View Details <i
                            class="las la-arrow-right ms-1"></i></button>
                </div>
            </div>

            <!-- Modal 2: Same-Day Delivery -->
            <div class="modal fade" id="sameDayDeliveryModal" tabindex="-1" aria-labelledby="sameDayDeliveryModalLabel"
                aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="sameDayDeliveryModalLabel">Same-Day Delivery</h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div class="modal-body">
                            <p>Need something delivered urgently? Our Same-Day Delivery service ensures your parcels
                                reach their destination on the same day. Perfect for critical and time-sensitive
                                deliveries, this service is supported by a robust network and real-time tracking. We
                                guarantee delivery within hours in select cities.</p>
                            <ul>
                                <li>Fast and efficient service</li>
                                <li>Available in metropolitan areas</li>
                                <li>Live tracking and notifications</li>
                            </ul>
                        </div>
                        <div class="modal-footer">
                            <a class="btn" style="background-color: #696cff;" href="contact.php">Contact Us</a>
            ...
            <div class="icon-box-item text-center col-lg-4 col-md-6 mb-4">
                <div class="rounded shadow py-5 px-4">
                    ...
                    <h3 class="mb-3">Cash on Delivery (COD)</h3>
                    <p class="mb-4">Payment collection from recipient for orders.</p>
                    <button class="btn btn-sm" style="background-color: #696cff;color: white;" data-bs-toggle="modal"
                        data-bs-target="#codModal">View Details <i class="las la-arrow-right ms-1"></i></button>
                </div>
            </div>

            <!-- Modal 3: Cash on Delivery (COD) -->
            <div class="modal fade" id="codModal" tabindex="-1" aria-labelledby="codModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <p>Our Cash on Delivery (COD) service offers a secure payment method for customers who
                                prefer to pay upon receiving their orders. Ideal for e-commerce businesses, this service
                                minimizes the risk of online payment fraud and enhances customer satisfaction.</p>
                            <ul>
                                <li>Flexible payment collection</li>
                                <li>Real-time payment tracking</li>
                                <li>Wide coverage for COD delivery</li>
                            </ul>
                        </div>
                        <div class="modal-footer">
                            <a class="btn" style="background-color: #696cff;" href="contact.php">Contact Us</a>
            ...
            <!-- Card 4: Logistics Solutions -->
            <div class="icon-box-item text-center col-lg-4 col-md-6 mb-4">
                <div class="rounded shadow py-5 px-4">
                    <div class="icon"> <i class="fas fa-house-damage"></i></div>
                    <h3 class="mb-3">Logistics Solutions</h3>
                    <p class="mb-4">Efficiently optimizing supply chain and transportation operations to deliver
                        seamless logistics solutions.</p>
                    <button class="btn btn-sm" style="background-color: #696cff;color: white;" data-bs-toggle="modal"
                        data-bs-target="#logisticsSolutionsModal">View Details <i
                            class="las la-arrow-right ms-1"></i></button>
                </div>
            </div>

            <!-- Modal 4: Logistics Solutions -->
            <div class="modal fade" id="logisticsSolutionsModal" tabindex="-1"
                aria-labelledby="logisticsSolutionsModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="logisticsSolutionsModalLabel">Logistics Solutions</h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div class="modal-body">
                            <p>Our Logistics Solutions are designed to streamline your supply chain operations. From
                                warehousing to transportation and delivery, we provide end-to-end solutions tailored to
                                your business needs. Our advanced technology ensures real-time visibility and efficient
            ...
            <!-- Card 5: Parcel Pickup and Delivery -->
            <div class="icon-box-item text-center col-lg-4 col-md-6 mb-4">
                <div class="rounded shadow py-5 px-4">
                    <div class="icon"> <i class="fas fa-money-check-alt"></i></div>
                    <h3 class="mb-3">Parcel Pickup and Delivery</h3>
                    <p class="mb-4">Aap isse is tarah se modify kar sakte hain:

"Reliable, fast, efficient, and hassle-free parcel pickup and delivery, right at your doorstep!"</p>
                    <button class="btn btn-sm" style="background-color: #696cff;color: white;" data-bs-toggle="modal"
                        data-bs-target="#parcelPickupModal">View Details <i
                            class="las la-arrow-right ms-1"></i></button>
                </div>
            </div>

            <!-- Modal 5: Parcel Pickup and Delivery -->
            <div class="modal fade" id="parcelPickupModal" tabindex="-1" aria-labelledby="parcelPickupModalLabel"
                aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="parcelPickupModalLabel">Parcel Pickup and Delivery</h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div class="modal-body">
                            <p>Our Parcel Pickup and Delivery service offers convenience like never before. We handle
                                everything from picking up your parcels from your location to delivering them safely to
                                their destination. Enjoy real-time tracking and timely updates at every stage of the
                                process.</p>
                            <ul>
        ...
        <div class="row align-items-center">
            <div class="col-lg-5">
                <div class="section-title">
                    <p class=" text-uppercase fw-bold mb-3" style="color: #696cff;">Affordable Price, Certified
                        Forwarders
                    </p>
                    <h1>Safe, Reliable & Express Logistic Solutions That Saves Your Time!</h1>
                    ...
                    <a class="btn  mt-4" style="background-color: #696cff;" href="contact.php">Contact Us</a>
                </div>
            </div>
            <div class="col-lg-7 text-center text-lg-end">
                <img style="width:80%" loading="lazy" decoding="async" src="images/safe.png" alt="About Ourselves"
                    class="img-fluid">
            </div>
        </div>
    </div>
