...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (mysqli_query($connect, $update)) {
        ...
        echo "<script>alert('Your changes have been saved successfully!'); window.location.href='manageAdmin.php';</script>";
        exit;
    } else {
                        ...
                        <div class='card-body pt-4'>
                            <div class='row g-6'>
                                ...
                                <div class='col-md-6'>
                                    ...
                                    <input value="<?php echo $fetch['password'] ?>" class='form-control' type='password'
