		...
		<div class="row">
			<div class="col-8 mx-auto text-center">
				...
				<ul class="list-inline breadcrumbs text-capitalize" style="font-weight:500">
					...
					<li class="list-inline-item">/ &nbsp; <a href="about.php">About</a>
					</li>
				</ul>
			</div>
		</div>
		...
		<div class="row justify-content-center align-items-center">
			<div class="col-lg-7">
				<div class="section-title">
					<h2 class="h1 mb-4" style="color: #696cff;">ABOUT US</h2>
					<div class="content pe-0 pe-lg-5">
						<p>Back in 1983, Ship Smart started with just 25 shipments on its first day and has since grown into Pakistan’s leading courier and logistics provider. Over the years, it has evolved from a courier service to the backbone of the country’s logistics industry.

While Ship Smart is driven by technology, its success lies in its people—those who value customers as the key to progress and rely on strategic insights to maintain the highest service standards.</p>
					</div>
				</div>
			</div>
			<div class="col-lg-4 mt-5 mt-lg-0">
				<img loading="lazy" decoding="async" src="images/about-us.png"
...
<section class="about-section section bg-tertiary position-relative overflow-hidden mb-6 pb-0 pt-6" style="height: ;">
	<div class="container ">
		<div class="row justify-content-center ">
			<div class="col-lg-5 mb-4">
				<div class="section-title">
					<h2 style="color: #696cff;">Who We Are?</h2>
				</div>
				<p class="">We are a dedicated team passionate about redefining courier services with trust,
					speed, and innovation. Our mission is to simplify your delivery needs by offering reliable,
					hassle-free solutions. Whether it’s documents, gifts, or packages, we ensure every item is
					handled with utmost care and professionalism.

				</p>
				<div class="content">
					<p>Built on the pillars of excellence and customer satisfaction, we’ve grown to
						become a trusted partner for individuals and businesses alike. At our core, we believe in
						creating seamless delivery experiences that save time, build connections, and make life
						easier.</p>
				</div>
			</div>
			<div class="col-lg-5 mb-4">
				<div class="section-title">
					...
					<img src="images/who-we-are.png" alt="Shipping Containers" class="img-fluid rounded ">
...
<section class="my-8 py-4" >
	<div class="container mt-5">
		<div class="section-title text-center">
			<h1 class="mb-4" style="color: #696cff;">Why Choose US?</h1>
			<p class="mb-4">"At "SHIPSMART", we offer fast, reliable, and secure delivery
				solutions tailored to your needs. With real-time tracking, affordable rates, and exceptional
				customer support, your satisfaction is our priority."</p>
		</div>
		<div class="row align-items-center">
			<!-- Left Section with Image and Text -->
			<div class="col-lg-6">
				<img style="width: 80%;" src="images/why-choose-us.png" alt="Shipping Containers" class="img-fluid rounded">
			</div>

			<div class="col-lg-6">
				<ul class="list-unstyled">
					<li class="d-flex align-items-start">
						<div class=" text-dark rounded-circle d-flex justify-content-center align-items-center"
							style="background-color: #696cff;width: 50px; height: 30px;width: 30px;">
							<i class="fa fa-check" style="color: white;"></i>
						</div>
						<div class="ms-3">
							<h5>Fast, secure, and reliable delivery solutions</h5>
							<p> We ensure your packages are delivered quickly and safely, no matter the destination.
							</p>
						</div>
					</li>
					<li class="d-flex align-items-start">
						...
						<div class="ms-3">
							<h5>Real-time tracking for complete transparency</h5>
							<p>Stay updated on your shipment's journey with our advanced tracking system.
							</p>
						</div>
					</li>
					<li class="d-flex align-items-start">
						...
						<div class="ms-3">
							<h5>Affordable rates for individuals and businesses</h5>
							<p>Enjoy competitive pricing without compromising on quality and service.
							</p>
						</div>
					</li>
					<li class="d-flex align-items-start">
						...
						<div class="ms-3">
							<h5>24/7 customer support for a seamless experience</h5>
							<p>Our dedicated support team is always available to assist you whenever you need help.
							</p>
						</div>
					</li>
				</ul>
		...
		<div class="row align-items-center">
				...
				<div class="row position-relative gy-4">
					<div class="icon-box-item col-md-6">
						<div class="block bg-white">
							...
							<h3 class="mb-3">Reliability You Can Trust</h3>
							<p class="mb-0">We ensure every package is delivered on time, every time. Your trust is
								our commitment.
					...
					<div class="icon-box-item col-md-6">
						<div class="block bg-white">
							...
							<h3 class="mb-3">Customer First, Always</h3>
							<p class="mb-0">Your satisfaction drives us. We listen, adapt, and deliver beyond your
								expectations.
					...
					<div class="icon-box-item col-md-6">
						<div class="block bg-white">
							...
							<h3 class="mb-3">Speed Meets Safety</h3>
							<p class="mb-0">Fast delivery with utmost care—because your package deserves both speed
								and security.
					...
					<div class="icon-box-item col-md-6">
						<div class="block bg-white">
							...
							<h3 class="mb-3">Innovation at Every Step</h3>
							<p class="mb-0">From tracking to handling, we use cutting-edge technology to make your
								courier journey smooth.

							</p>
						</div>
					</div>
					<div class="has-shapes">
						<svg class="shape shape-1 " style="color: #696cff;" width="71" height="71" viewBox="0 0 119 119"
						...
						<svg class="shape shape-2 " style="color: #696cff;" width="100" height="100"
			...
			<div class="col-lg-6 mt-5 mt-lg-0">
				<div class="section-title ps-0 ps-lg-5">
					<p class=" text-uppercase fw-bold mb-3" style="color: #696cff;">Values We Provide</p>
					<h2 class="h1">Our Core Values</h2>
					<div class="content">
						<p>We prioritize trust, reliability, and customer satisfaction in every delivery. Committed
							to excellence, we ensure safe and timely services tailored to your needs. Your happiness
							is our mission, and we deliver it with care.</p>
						<p>We believe in creating seamless experiences through integrity, innovation, and
							dedication. Every parcel we handle reflects our promise of safety, speed, and
							efficiency. With a customer-first approach, we aim to build lasting relationships by
							exceeding expectations at every step of the journey.</p>
					</div>
				</div>
			</div>
		</div>
...
<section class="section teams">
	<div class="container">
		<div class="row justify-content-center">
			<div class="col-12">
				<div class="section-title text-center">
					<p class=" text-uppercase fw-bold mb-3" style="color: #696cff;">Questions You Have</p>
					<h1>People Behind Us</h1>
					<p class="mb-0">We’re here to answer all your queries, from services to tracking and beyond. Our
						dedicated support team ensures you’re never left wondering. Ask away, and we’ll guide you
						...
						<ul class="card-social list-inline">
							<li class="list-inline-item">
								<a class="facebook" href="https://www.facebook.com" target="_blank">
									<i class="fab fa-facebook" style="color: #696cff;"></i>
								</a>
							</li>
							<li class="list-inline-item">
								<a class="twitter" href="https://www.twitter.com" target="_blank">
									<i class="fab fa-twitter" style="color: #696cff;"></i>
								</a>
							</li>
							<li class="list-inline-item">
								<a class="instagram" href="https://www.instagram.com" target="_blank">
									<i class="fab fa-instagram" style="color: #696cff;"></i>
								</a>
							</li>
						</ul>
