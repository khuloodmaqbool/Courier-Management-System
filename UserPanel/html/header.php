      ...
      <aside id='layout-menu' class='layout-menu menu-vertical menu bg-menu-theme'>
        <div class='app-brand demo'>
          <a href='index.php' class='app-brand-link'>
            ...
            <!-- <span class = 'app-brand-text demo menu-text fw-bold ms-2'>Ship Smart</span> -->
          </a>
        ...
        <ul class='menu-inner py-1'>
          ...
          <li class='menu-item <?php echo $currentPage == 'addCourier.php' ? 'active' : ''; ?>'>
            <a href='addCourier.php' class='menu-link'>
              <!-- <i class = 'menu-icon tf-icons bx bx-table'></i> -->
              <i class='fa fa-truck me-2'></i>
              <div class='text-truncate' data-i18n='Tables'>Book a Courier</div>
            </a>
          </li>
          ...
          <li class='menu-item <?php echo $currentPage == 'manageCourier.php' ? 'active' : ''; ?>'>
            <a href='manageCourier.php' class='menu-link'>
              ...
              <div class='text-truncate' data-i18n='Tables'>Track Courier</div>
            </a>
          </li>
              ...
              <li class="nav-item navbar-dropdown dropdown-user">
                <a class="nav-link p-0" href="javascript:void(0);" id="dropdownMenuButton"
                  ...
                  <div class="avatar avatar-online">
                    <img style="background-color: lightgray;" src="../images/<?php echo $_SESSION['profile_picture']; ?>" alt
                      class="w-px-40 h-100 rounded-circle p-1" />
                  </div>
                </a>
