		...
		<div class="row">
			<div class="col-8 mx-auto text-center">
				...
				<ul class="list-inline breadcrumbs text-capitalize" style="font-weight:500">
					...
					<li class="list-inline-item">/ &nbsp; <a href="how-it-works.php">How it works</a>
					</li>
				</ul>
			</div>
		</div>
		...
		<div class="row justify-content-center align-items-center">
			<div class="col-lg-7">
				<div class="section-title text-center">
					<H1 class=" text-uppercase fw-bold mb-3" style="color: #696cff;">HOW ITS WORKS</H1>
					<h4>"Discover how we make delivering and receiving packages simple and stress-free."</h4>
				</div>
			</div>
		</div>
				...
				<div class="row justify-content-center">
					<div class="step-item col-lg-4 col-md-6">
						<div class="text-center">
							<p class="count" style="background-color: #696cff;">01</p>
							<h3 class="mb-3">Book Your Delivery</h3>
							<p class="mb-0">Schedule a pickup online or through our app—quick and hassle-free.
					...
					<div class="step-item col-lg-4 col-md-6">
						<div class="text-center">
							<p class="count" style="background-color: #696cff;">02</p>
							<h3 class="mb-3">We Pick It Up</h3>
							<p class="mb-0">Our courier collects your package from your doorstep.
					...
					<div class="step-item col-lg-4 col-md-6">
						<div class="text-center">
							<p class="count" style="background-color: #696cff;">03</p>
							<h3 class="mb-3">Track and Deliver</h3>
							<p class="mb-0">Monitor your shipment in real-time as we safely deliver it to the destination.
		...
		<div class="row justify-content-center align-items-center">
			<div class="col-lg-6">
				<div class="section-title text-center">
					...
					<p>"We are dedicated to providing fast, reliable, and secure delivery services that meet your needs, ensuring complete customer satisfaction every time."</p>
				</div>
			</div>
		</div>
		<div class="row justify-content-center">
			<div class="icon-box-item col-lg-4 col-md-6">
				<div class="block">
					...
					<p class="mb-0">"Experience delivery that's both fast and hassle-free, designed to save you time and provide maximum convenience."</p>
				</div>
			</div>
			<div class="icon-box-item col-lg-4 col-md-6">
				<div class="block">
					...
					<p class="mb-0">"Count on us for secure and reliable deliveries, ensuring your packages reach their destination safely and on time."</p>
				</div>
			</div>
			<div class="icon-box-item col-lg-4 col-md-6">
				<div class="block">
					...
					<p class="mb-0">
						"Our customers trust us for reliable, secure, and timely deliveries, making us their go-to courier service."</p>
				</div>
			</div>
		</div>
	</div>
